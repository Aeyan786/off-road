...
/**
 * How many categories sit at each level of the tree: [top-level,
 * subcategories, sub-subcategories, deeper...]. The UI works with three
 * levels; anything deeper is reported by the caller as its own figure.
 */
export function countCategoryLevels(tree) {
  const counts = [];
