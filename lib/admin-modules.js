...
export const ADMIN_ROUTES = [
  ...
  // Moderating product reviews belongs with the catalogue, so it uses the
  // products module rather than adding a new one.
  { key: "products", path: "/admin/reviews" },
  { key: "reports", path: "/admin/reports" },
  { key: "email_templates", path: "/admin/templates" },
