...
export const PRODUCT_FIELDS = [
  ...
  // Accepts either media file names ("xyz.png", resolved against the media
  // library on import) or full URLs. Comma-separate for multiple images.
  { key: "images", label: "Images (file name or URL)", type: "text", required: false },
